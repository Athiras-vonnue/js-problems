...
function capitalizeLetter(string) {
  ...
  if (string.length > 0) {
    wordsArray = string.split(" "); //string.split is inbuilt function
    for (let word of wordsArray) {
      for (let i = 0; i < word.length; i++) {
        if (i == 0) {
          sentence += word[0].toUpperCase(); //toUpperCase is an inbuilt function
        } else {
          sentence += word[i];
        }
      }
...
/*
 citation:
 string.split and string.toUpperCase() are inbult functions
*/
